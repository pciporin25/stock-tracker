...
Date Completed: 4/13/18
Number of hours spent: 6
Collaborators: N/A
Resources consulted: React documentation and tutorials, StackOverflow
Assets: Alphavantage Stock Market API, React, Node/NPM, crete-react-app npm module
Bugs/Concerns: N/A
Extra credit: N/A

I took advantage of this project to explore the React library, which is something I have been hoping to learn since enrolling in the course. Through the project, I became comfortable with
React's syntax and using tools like props and components.  I also gained familiarity with the
Alphavantage API which my group plans to use heavily in our final project. Unfortuately, it has come to my attention that the API can be very slow to fetch data, which should definitely be kept in mind as we develop our final project.
